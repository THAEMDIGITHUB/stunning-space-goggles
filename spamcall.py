#Decompile By Tran Minh Quang ( Vodka Coder )
#Buy Tools Crack Inbox Me
#Type File: fullcode.py
import os
...
\033[1;34m      ╚═╝   ╚═╝     ╚═╝ ╚══▀▀═╝       ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝
\033[1;32m=======================================================================
\033[1;37m ADMIN:\033[1;32m⠀LÙ VĂN LONG 
\033[1;37m ZALLO SUPPORT:\033[1;32m⠀
\033[1;37m FACEBOOK:\033[1;32m⠀Van Long zZ
\033[1;32m=======================================================================
"""
for h in banner:
       sys.stdout.write(h)
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("[ HDT - TOOL ] Send Sms - Call | Api - Free | Delay : 5 | Status : Thành Công ",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f" HDT - TOOL | MADE IN VIET NAM 🇻🇳 \r",end="")
